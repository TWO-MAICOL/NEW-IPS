...
export const Login = ()=> {
  ...
  if(cookies.get('user')){
    ...
    <div className="page-header align-items-start min-vh-100" style={{backgroundImage:'url( https://img.freepik.com/foto-gratis/enfermera-practicando-medicina-clinica_23-2149868906.jpg?w=1380&t=st=1697738329~exp=1697738929~hmac=8644305c04384322b07b24f565b0cfe4990da43c25d9c6dfc850fec75865d960)'}}>
