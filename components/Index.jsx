...
export const Index = ()=> {
    ...
    <header id="header" className="fixed-top d-flex align-items-center header-scrolled header-transparent">
      <div className="container d-flex align-items-center justify-content-between">
        ...
        <div className="logo">
          <h1><a href="/"><span>Nueva IPS </span></a></h1>
      ...
      <div className="container">
        ...
        <div className="row content">
          <div className="col-md-4" data-aos="fade-right">
            <img src="../assets/img/web/details-1.png" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row content">
          <div className="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="../assets/img/web/details-2.png" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row content">
          <div className="col-md-4" data-aos="fade-right">
            <img src="../assets/img/web/details-3.png" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row content">
          <div className="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="../assets/img/web/details-4.png" className="img-fluid" alt=""/>
          </div>
          <div className="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../assets/img/web/testimonials/testimonials-1.jpg" className="testimonial-img" alt=""/>
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../assets/img/web/testimonials/testimonials-2.jpg" className="testimonial-img" alt=""/>
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
                  <i className="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../assets/img/web/testimonials/testimonials-3.jpg" className="testimonial-img" alt=""/>
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <p>
                  <i className="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../assets/img/web/testimonials/testimonials-4.jpg" className="testimonial-img" alt=""/>
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <p>
                  <i className="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../assets/img/web/testimonials/testimonials-5.jpg" className="testimonial-img" alt=""/>
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <p>
                  <i className="bx bxs-quote-alt-left quote-icon-left"></i>
        ...
        <div className="row" data-aos="fade-left">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="member" data-aos="zoom-in" data-aos-delay="100">
              <div className="pic"><img src="../assets/img/web/team/team-1.jpg" className="img-fluid" alt=""/></div>
          ...
          <div className="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div className="member" data-aos="zoom-in" data-aos-delay="200">
              <div className="pic"><img src="../assets/img/web/team/team-2.jpg" className="img-fluid" alt=""/></div>
              <div className="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div className="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div className="member" data-aos="zoom-in" data-aos-delay="300">
              <div className="pic"><img src="../assets/img/web/team/team-3.jpg" className="img-fluid" alt=""/></div>
              <div className="member-info">
